...
struct Video{
    ...
    static func fetchVideoList() -> [Video]{
        ...
        let v2 = Video(videoName: "Ghost of Tsushima", videoFileName: "video2", description: "Trailer of Assassin Creed: Valhala", thumbnailFileName: "thumbV2")
        let v3 = Video(videoName: "CyberPunk 2077", videoFileName: "video3", description: "Trailer of Assassin Creed: Valhala", thumbnailFileName: "thumbV3")
